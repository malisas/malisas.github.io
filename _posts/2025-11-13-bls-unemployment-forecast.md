...
The Bureau of Labor Statistics publishes the U.S. unemployment rate monthly, dating back to January 1948. The unemployment rate has been rising for about 2 years now (Dec 2025)\*:

![unemployment1](/assets/images/bls_unemployment/unemployment1.svg){:height="60%" width="60%"}  

\* <sub> You can download these data yourself on the Federal Reserve Bank of St. Louis site [here](https://fred.stlouisfed.org/categories/32447). Data exist through September 2025 at the time of this writing.
...
It goes without saying that predicting the future accurately is difficult. Regardless, it is an interesting exercise to see what *can* be learned from the historical data that do exist (and which are easily accessible).
